...
@implementation FormTableControllerForgot
...
- (UITableViewCell *)tableView:(UITableView *)tableView 
	...
	switch ( indexPath.row ) {
        ...
        case 1: {
            ...
            tf = passwordField_ = [self makeTextField:self.password placeholder:@"Enter New Password"];
        ...
        case 2: {
            //cell.textLabel.text = @"Password" ;
            tf = otpField_ = [self makeTextField:self.otp placeholder:@"PIN (CHECK YOUR SMS)"];
            tf.returnKeyType = UIReturnKeyDone;
        ...
        case 3: {
            ...
            loginBut.font = [UIFont fontWithName:@"SFUIDisplay-Bold" size:(loginBut.bounds.size.height*0.4)];
            ...
            [signUpBut setTitle:@"SUBMIT" forState:UIControlStateNormal];
            ...
            [signUpBut addTarget:myDelegate action:@selector(resetPassword) forControlEvents:UIControlEventTouchUpInside];
            signUpBut.alpha = 1;
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string{
   ...
   // NSLog(@"DATA CHECK %@  ?= %@",self.email,textField.text);
